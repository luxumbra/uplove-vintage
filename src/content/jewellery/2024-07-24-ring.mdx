...
tags: ['jewellery']
author: "Ria"
image: { src: https://picsum.photos/800/500, alt: Vintage Ring, positionx: 30%, positiony: 20%}
...
import image1 from '../../images/gallery/image.002.jpeg';
import image2 from '../../images/gallery/image.003.jpeg';

<MasonryLayout images={[
      { src: image1, alt: "Ring 1" },
    { src: image2, alt: "Ring 2" },
